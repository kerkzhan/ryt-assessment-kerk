...
const textareaInputStyle = tva({
  base: "p-2 web:outline-0 web:outline-none flex-1 align-text-top placeholder:text-typography-500 web:cursor-text web:data-[disabled=true]:cursor-not-allowed",
  parentVariants: {
    size: {
      sm: "text-sm",
      md: "text-base",
